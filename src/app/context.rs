...
fn find_nth_l3_heading_in_section(lines: &[String], section: &str, n: usize) -> Option<usize> {
...
pub fn context_heading_line(lines: &[String], context: &Context) -> usize {
    match context {
        ...
        Context::NoteBlock(n) => find_nth_l3_heading_in_section(lines, "## Notes", *n).unwrap_or(0),
    }
}
